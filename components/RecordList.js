...
export default function RecordList({records, categories, setRecords, incomeStyle, expenseStyle}) {
    ...
    return (
        <ListGroup className={styles.listContainer}>
            {records.map(record => {
                ...
                const amountStyle = (record.categoryType === 'Income') ? incomeStyle : expenseStyle
                    ...
                    <Row className={styles.listItems}>
                        <Col>
                            <Row className={styles.subList}>
                                <Col className={styles.listItemLabels}><strong>{record.description}</strong></Col>
                                <Col className={styles.listItemLabels} style={amountStyle}><strong>{Math.abs(record.amount)}</strong></Col>
                            </Row>
                        </Col>
                        <Col>
                            <Row className={styles.subList}>
                                <Col className={styles.listItemLabels}>{record.categoryName}</Col>
                                <Col className={styles.listItemLabels} style={amountStyle}>{record.categoryType}</Col>
                            </Row>
                        </Col>
